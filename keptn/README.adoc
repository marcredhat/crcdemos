...
----
keptn onboard service unleash-db --project=unleashcrc --chart=./unleash-db
keptn onboard service unleash --project=unleashcrc --chart=./unleash
----

----
keptn send event new-artifact --project=unleashcrc --service=unleash-db --image=postgres:10.4
keptn send event new-artifact --project=unleashcrc --service=unleash --image=docker.io/keptnexamples/unleash:1.0.0
----

----
keptn send event start-evaluation --project=unleashcrc  --stage=dev --service=unleash --timeframe=2m
