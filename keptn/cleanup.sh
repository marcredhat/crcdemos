...
curl -L https://raw.githubusercontent.com/marcredhat/crcdemos/master/keptn/deploykeptn.sh -o deploykeptn.sh
sudo chmod +x ./deploybookinfo.sh
sudo chmod +x ./mesh1.sh
sudo chmod +x ./deploykeptn.sh
