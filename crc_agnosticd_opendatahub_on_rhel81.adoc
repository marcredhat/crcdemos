...
== Draft lab guide showing how to set up CodeReady Containers, OpenShift 4.1, Ansible Agnostic Deployer, OpenDataHub, Process Automation Manager, Change Data Capture with Debezium and Kafka, Tekton Pipelines on a RHEL 8.1 physical server
