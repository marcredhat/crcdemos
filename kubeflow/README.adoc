...
* Add permissions for  for workflow delete and workflows/finalizers on `argo` ClusterRole.
...
----
We also need to create the PVC for the pipeline

oc create -f https://raw.githubusercontent.com/marcredhat/crcdemos/master/kubeflow/marcpvc
----
