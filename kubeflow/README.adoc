...
The above solution uses Dex as OIDC provider. It should be relatively straightforward to use RH-SSO/Keycloak,
Please find labs and videos with RH-SSO on OpenShift 4.2 at http://bit.ly/33rjfry
