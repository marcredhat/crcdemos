...
----
aws s3api --endpoint http://s3g-yunikorn.apps-crc.testing create-bucket --bucket=marcbucket
----
...
....
2020-10-11 00:44:09 INFO  RpcClient:459 - Creating Bucket: s3v/marcbucket, with Versioning false and Storage Type set to DISK and Encryption set to false
2020-10-11 00:44:09 INFO  BucketEndpoint:205 - Location is /marcbucket
----
